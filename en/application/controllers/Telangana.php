...
class Telangana extends CI_Controller {
	...
	function state($state)
	{
		...
		$data['seats_data'] = $this->Englishm->get_seats_data_state($state);
		$data['campaigns_data'] = $this->Englishm->get_campaigns_data_state($state);
		...
		{
			$rid = implode(',',$rid1);
			$data['campaigners_details'] = $this->Englishm->get_campaigners_details($rid);
		}
		else
		{
			$rid = '';
		...
		$data['election_data'] = $this->Englishm->get_election_schedule();		
		$data['star_candidate'] = $this->Englishm->get_star_candidate();
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
		$data['show'] = 1;
		
		$this->load->view('common/header',$data);
		//$this->load->view('common/main_navigation');
		//$this->load->view('english/map/ts/'.strtolower($data['state']->shortname),$data);
		$this->load->view('english/views/state/stateview',$data);
	...
	function district($district='')
	{
		if(empty($district) )
		{
			$data['district'] = $this->Englishm->get_all_district();
		...
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
			...
			$this->load->view('english/views/district/all',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
		...
		else
		{
			...
			$data['campaigns_data'] = $this->Englishm->get_campaigns_data_district($district);
			foreach($data['campaigns_data'] as $row)
			{
				$rid1[] = $row['id'];
			}
		...
		$data['star_candidate'] = $this->Englishm->get_star_candidate();
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
		$data['candidate_details_district'] = $this->Englishm->get_candidates_by_district($district);

			$this->load->view('common/header');
			//$this->load->view('common/main_navigation');
			//$this->load->view('english/map/ts/district/'.strtolower(str_ireplace(' ', '-', $data['district']->engname)),$data);
			$this->load->view('english/views/district/districtview',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
	}
	...
	function constituency($const='')
	{
		if(empty($const) )
		{
			$data['const'] = $this->Englishm->get_all_const();
		...
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
			//print_r($data);
			$this->load->view('common/header');
			$this->load->view('english/views/constituency/all',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
		else
		{
			...
			$data['seats_data'] = $this->Englishm->get_seats_data_const($const); 
			$data['campaigns_data'] = $this->Englishm->get_campaigns_data_const($const);
			$data['election_result'] = $this->Englishm->get_previous_election_result($const);
			foreach($data['campaigns_data'] as $row)
			{
				$rid1[] = $row['id'];
			}
		...
		$data['star_candidate'] = $this->Englishm->get_star_candidate();
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
		$data['candidate_details_const'] = $this->Englishm->get_candidates_by_const($const);

			$this->load->view('common/header');
			//$this->load->view('common/main_navigation');
			//$this->load->view('english/map/ts/constituency/constmap',$data);
			$this->load->view('english/views/constituency/constview',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
	}
	...
	function party($party_state='')
	{
		...
		{
			$data['parties'] = $this->Englishm->get_all_parties();
		...
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
			//print_r($data);
			$this->load->view('common/header');
			$this->load->view('english/views/party/all',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
		else
		{
			...
			$data['campaigns_data'] = $this->Englishm->get_campaigns_data_party($partyid,$state);
			foreach($data['campaigns_data'] as $row)
			{
				$rid1[] = $row['id'];
			}
			...
			$this->load->view('common/header');
			$this->load->view('english/views/party/partyview',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
	}
	...
	function candidate($candidate_state ='')
	{
		...
		$data['pre_result'] = $this->Englishm->get_pre_result_by_candidate($candidateid,$state);
		$data['seats_data'] = $this->Englishm->get_seats_data_by_candidate($candidateid,$state);
		$data['campaigns_data'] = $this->Englishm->get_campaigns_data_candidate($candidateid,$state);
		foreach($data['campaigns_data'] as $row)
		{
			$rid1[] = $row['id'];
		}
		...
		$this->load->view('common/header');
		$this->load->view('english/views/candidate/candidateview',$data);
		$this->load->view('common/sidebar');	
		$this->load->view('common/footer');	
	}
	...
	function schedule()
	{
		...
		$this->load->view('common/header');
		$this->load->view('english/views/election_schedule',$data);
		$this->load->view('common/sidebar');	
		$this->load->view('common/footer');	
	}
	...
	function campaign()
	{
		...
		$data['campaigners_details'] = $this->Englishm->get_campaigners_details('');
		$data['campaigns_data'] = $this->Englishm->get_campaigns_data();
		...
		$this->load->view('common/header');
		$this->load->view('english/views/campaignview',$data);
		$this->load->view('common/sidebar');	
		$this->load->view('common/footer');	
	}
 ...
 // ============================  Graph Json ============================================ //
	...
	function pre_result_json_by_state($state){
		...
		$jsonData = $this->Englishm->get_pre_result_json_by_state($state);
		//print_r($jsonData);
		...
		fclose($fp);
		echo $json;
		//$this->load->view('english/views/state_chart');
	}
	...
	function vote_share_json_state($state){
		 header('Access-Control-Allow-Origin: *'); 
		$jsonData = $this->Englishm->get_vote_share_json_by_state($state);
		//print_r($jsonData);
	...
	function pre_result_json_by_district($district){
		 header('Access-Control-Allow-Origin: *'); 
		$district = str_ireplace('-', ' ', $district);
		$jsonData = $this->Englishm->get_pre_result_json_by_district($district);
		//print_r($jsonData);
	...
	function pre_all_result_json_by_district($district){
		 header('Access-Control-Allow-Origin: *'); 
		$district = str_ireplace('-', ' ', $district);
		$jsonData = $this->Englishm->get_pre_all_result_json_by_district($district);
		//print_r($jsonData);
	...
	function vote_share_json_district($district){
		 ...
		 header('Access-Control-Allow-Origin: *'); 
		$district = str_ireplace('-', ' ', $district);
		$jsonData = $this->Englishm->get_vote_share_json_by_district($district);
		//print_r($jsonData);
	...
	function pre_result_json_by_const($constid){
		...
		$jsonData = $this->Englishm->get_pre_result_json_by_const($constid);
		//print_r($jsonData);
	...
	function pre_result_json_by_party($party){
		...
		$jsonData = $this->Englishm->get_pre_result_json_by_party($party);
		//print_r($jsonData);

			
	$json = '{
				  "cols": [
				        {"id":"","label":"Year","pattern":"","type":"number"},
...
*/
	...
	function state_json()
	{
			...
			exec('curl http://192.168.150.157/elections-2018/en/telangana/pre_result_json_by_state/telangana');
			exec('curl http://192.168.150.157/elections-2018/en/telangana/vote_share_json_state/telangana');
		
	}

	function district_json()
	{
		$district = $this->Englishm->get_all_district();
		foreach($district as $row)
		{
			$dist = strtolower(str_ireplace(' ', '-', $row['engname']));
			echo $dist.'<br>';
			exec('curl http://192.168.150.157/elections-2018/en/telangana/pre_result_json_by_district/'.$dist);
			exec('curl http://192.168.150.157/elections-2018/en/telangana/pre_all_result_json_by_district/'.$dist);
		}
	}

	function const_json()
	{
		$const = $this->Englishm->get_all_const();
		foreach($const as $row)
		{
			$const = strtolower(str_ireplace(' ', '-', $row['engname']));
			echo $const.'<br>';
			exec('curl http://192.168.150.157/elections-2018/en/telangana/pre_result_json_by_const/'.$const);
		}
	}
