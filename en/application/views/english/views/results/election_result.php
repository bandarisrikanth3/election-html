...
<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:0px;">
	...
	?>
				...
				<div class="col-md-4 col-sm-4 col-xs-12" >
					<legend><?php echo $results1[0]['en_statename'] .'  ( '.$sum.' / 119 )';?></legend>
						<div>
	...
	?>
									<tr>
										<?php 
											...
											{ 
										?>
											<td><?php echo '<img src="/elections-2018/'.$row['symbol_path'].'" width="25px" height="20px">&nbsp;&nbsp;'.$row['en_partyname'];?></td>
										<?php } else { ?>
											<td><?php echo $row['en_partyname'];?></td>
										<?php } ?>
...
<!-- Chattis Garh -->
	...
	?>
				<div class="col-md-4 col-sm-4 col-xs-12" >
					<legend><?php echo $results2[0]['en_statename'].'  ( '.$sum.' / 90 )';?></legend>
	...
	?>
				...
				<?php 
					...
					$sum += 8;
				?>
					<legend><?php echo $results5[0]['en_statename'].'  ( '.$sum.' / 40 )';?></legend>
						<div class="table-responsive">
	...
	?>
				<div class="col-md-4 col-sm-4 col-xs-12">
					<!-- Madhya Pradesh -->
						<legend><?php echo $results3[0]['en_statename'].'  ( '.$sum.' / 230 )';?></legend>
						<div class="table-responsive">
	...
	?>
			...
			?>
						<legend><?php echo $results4[0]['en_statename'].'  ( '.$sum.' / 199 )';?></legend>
						<div class="table-responsive">
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="col-md-6 col-sm-6 col-xs-12">
		...
		<div style="height:50px;text-align:center">
			<a href="https://english.sakshi.com/topic/Telangana%20Elections%202018" target="_blank">
				<img src="/elections-2018/assets/images/eng_stories.gif" width="300px">
			</a>
		</div>
	</div>
	<div class="col-md-6 col-sm-6 col-xs-12" style="padding:5px">
		<!-- Sticky 2-->
			<div style="height:50px;text-align:center">
				<a href="https://www.sakshi.com/elections-2018/en/telangana/results.html" target="_blank">
				<img src="/elections-2018/assets/images/eng_result.gif" width="300px">
			</a>
			</div>
	</div>
</div>