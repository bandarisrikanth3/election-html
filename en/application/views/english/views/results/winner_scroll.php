		...
		<table class="table" >
			...
			?>
										<td>
													...
													<h5 style="font-size:18px;font-weight:bold;color:#C62828 ;"><?php echo $row['eng_constname'] ; ?>&nbsp;<img src="<?php echo base_url().$row['symbol'];?>" width="25px" height="20px"></h5>
													...
													<?php }	?>
													<h5 style="font-size:15px;font-weight:bold;color:#069 ;"><?php echo $row['english_candidate_name'];?></h5>
													<h5 style="font-size:12px;font-weight:bold;color:#eb6a14 ;"><?php echo  $row['eng_partyname'];?></h5>
													<?php 	
													...
													?>
																...
																<h5 style="font-size:15px;font-weight:bold;color:green ;">Won&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-thumbs-up"></h5>
													<?php
															}
													?>
													<?php 	
													...
													?>
																...
																<h5 style="font-size:15px;font-weight:bold;color:red ;">Loss&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-thumbs-down"></h5>
													<?php
															}
													?>
													<?php 	

															if(!empty($row['eng_article']) && $row['eng_article'] != 'null')
															{
													?>
														
																<a href="<?php echo $row['eng_article'];?>" target="_blank">
																	<h5 style="float:right;font-size:12px;font-weight:bold;color:#ed1e24 ;    margin-top: -10px;">More »</h5>
																</a>
													<?php
															}
													?>
