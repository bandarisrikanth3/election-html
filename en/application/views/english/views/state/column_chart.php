...
<script type="text/javascript">
  ...
  function drawChart() {
     ...
     report = $.ajax({
        url: "<?php echo '/elections-2018/en/Jsons/telangana/pre_results_state.json';?>",
        dataType: "json",
        async: false
        }).responseText;
    //alert(report);
