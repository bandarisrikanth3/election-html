...
class ResultsM extends CI_Model {
	...
	function get_all_candidate_details()
	{
		...
		$query = $this->db->query('select a.hindiname,a.img_path,a.engname,a.telname,(select shortname from parties where id = a.partycode)party,(select symbolpath from parties where id = a.partycode)symbol,(select hindiname from constituency where id = a.constid)const from candidates a where a.year= 2018 ');
