...
class EnglishM extends CI_Model {
	...
	{
		$query = $this->db->query('select a.*,(select engname from state where id = a.stateid)eng_statename,(select hindiname from state where id = a.stateid)tel_statename from district a where a.stateid = 2 group by a.stateid,a.id ');
		return $query->result_array();
	...
	{
		$this->db->select('a.*,(select engname from state where id = a.stateid)statename,(select telname from state where id = a.stateid)tel_statename,(select hindiname from state where id = a.stateid)hindi_statename')->from('district a');
	...
	function get_campaigns_data_district($district)
	{
		...
		$query = $this->db->query(' select a.*,(select engname from state where id = a.stateid)eng_statename,(select engname from district where id = a.distid and stateid = a.stateid)eng_distname,(select engname from constituency where id = a.constid and stateid = a.stateid)eng_constname,(select engname from parties where id=a.partyid and stateid = a.stateid)eng_partyname,(select engname from campaigners where id = a.campainerid)eng_campaigner,(select telname from state where id = a.stateid)tel_statename,(select telname from district where id = a.distid and stateid = a.stateid)tel_distname,(select telname from constituency where id = a.constid and stateid = a.stateid)tel_constname,(select shortname from parties where id=a.partyid and stateid = a.stateid)tel_partyname,(select hindiname from campaigners where id = a.campainerid)tel_campaigner from campaigns a where a.distid = (select id from district where engname like "'.$district.'")  order by a.campaign_date desc' );
		return $query->result_array();
	}
	...
	{
		$query = $this->db->query('select a.*,(select engname from state where id = a.stateid)eng_statename,(select hindiname from state where id = a.stateid)tel_statename,(select hindiname from district where id = a.distid)teldistname from constituency a where a.stateid = 2 group by a.stateid,a.distid,a.id order by engdistrictname,engname ');
		return $query->result_array();
	...
	{
		$this->db->select('a.*,(select engname from state where id = a.stateid)statename,(select engname from district where id = a.distid)distname,(select hindiname from state where id = a.stateid)telstatename,(select hindiname from district where id = a.distid)teldistname')->from('constituency a');
	...
	function get_seats_data_const($const)
	{
		...
		$query = $this->db->query('  select a.*,group_concat(a.noofvotes order by a.status)noofvotes,(select engname from state where id = a.stateid)eng_statename,(select engname from district where id = a.distid )eng_distname,(select engname from constituency where id = a.constid)eng_constname,group_concat((select engname from parties where id=a.partycode) order by a.status)eng_partyname,group_concat((select engname from candidates where id=a.candidatecode) order by a.status)eng_candidatename,(select telname from state where id = a.stateid)tel_statename,(select hindiname from district where id = a.distid )tel_distname,(select telname from constituency where id = a.constid)tel_constname,group_concat((select shortname from parties where id=a.partycode) order by a.status)tel_partyname,group_concat((select hindiname from candidates where id=a.candidatecode) order by a.status)tel_candidatename,(select noofvoters from constituency where id = a.constid)totalvotes from pre_results a where a.constid = (select id from constituency where engname like "'.$const.'" and status = 1) and a.year != 0   group by a.constid,a.year order by a.constid,a.year desc,a.noofvotes desc' );
		return $query->result_array();
	}
	...
	function get_campaigns_data_const($const)
	{
		...
		$query = $this->db->query(' select a.*,(select engname from state where id = a.stateid)eng_statename,(select engname from district where id = a.distid and stateid = a.stateid)eng_distname,(select engname from constituency where id = a.constid and stateid = a.stateid)eng_constname,(select engname from parties where id=a.partyid and stateid = a.stateid)eng_partyname,(select engname from campaigners where id = a.campainerid)eng_campaigner,(select telname from state where id = a.stateid)tel_statename,(select hindiname from district where id = a.distid and stateid = a.stateid)tel_distname,(select hindiname from constituency where id = a.constid and stateid = a.stateid)tel_constname,(select shortname from parties where id=a.partyid and stateid = a.stateid)tel_partyname,(select hindiname from campaigners where id = a.campainerid)tel_campaigner from campaigns a where a.constid = (select id from constituency where engname like "'.$const.'" and status = 1)  order by a.campaign_date desc' );
		return $query->result_array();
	}
	...
	{
		$this->db->select('a.*,a.hindiname as telname,(select engname from state where id = a.stateid)statename,(select engname from district where id = a.distid)distname,(select engname from constituency where id = a.constid)constname,(select engname from parties where id=a.partycode )partyname,(select hindiname from district where id = a.distid)teldistname,(select hindiname from constituency where id = a.constid)telconstname')->from('candidates a');
	...
	function get_campaigns_data_party($partyid,$state)
	{
		...
		$query = $this->db->query(' select a.*,(select engname from state where id = a.stateid)eng_statename,(select engname from district where id = a.distid )eng_distname,(select engname from constituency where id = a.constid)eng_constname,(select engname from parties where id=a.partyid )eng_partyname,(select telname from parties where id=a.partyid )tel_partyname,(select engname from campaigners where id = a.campainerid)eng_campaigner,(select telname from state where id = a.stateid)tel_statename,(select hindiname from district where id = a.distid and stateid = a.stateid)tel_distname,(select hindiname from constituency where id = a.constid and stateid = a.stateid)tel_constname,(select shortname from parties where id=a.partyid and stateid = a.stateid)tel_partyname,(select hindiname from campaigners where id = a.campainerid)tel_campaigner from campaigns a where a.partyid ="'.$partyid.'" and a.stateid = (select id from state where engname like "'.$state.'") order by a.campaign_date desc' );
		return $query->result_array();
	}
	...
	{
		$this->db->select('a.*,(select shortname from parties where id = a.partycode)telpartyname,(select hindiname from constituency where id = a.constid)telconstname')->from('candidates a')->where('a.star',1);
		$query = $this->db->get();
		return $query->result_array();
	}
	...
	{
		//$query = $this->db->query('select a.*,(select engname from state where id = a.stateid)statename,(select engname from district where id = a.distid )distname,(select engname from constituency where id = a.constid )constname,(select engname from parties where id=a.partycode)partyname,(select hindiname from constituency where id = a.constid )telconstname,(select shortname from parties where id=a.partycode)telpartyname from candidates a where a.partycode is not null and a.year=2014  group by a.id,a.constid order by telconstname ');
		$query = $this->db->query('select a.hindiname,(select shortname from parties where id = a.partycode)party,(select hindiname from constituency where id = a.constid)const from candidates a where a.year= 2018 ');
