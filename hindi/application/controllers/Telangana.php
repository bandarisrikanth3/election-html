...
*/
	...
	function state_json()
	{
			...
			exec('curl http://192.168.150.157/elections-2018/hindi/telangana/pre_result_json_by_state/telangana');
			exec('curl http://192.168.150.157/elections-2018/hindi/telangana/vote_share_json_state/telangana');
	...
	function district_json()
	{
		...
		foreach($district as $row)
		{
			...
			echo $dist.'<br>';
			exec('curl http://192.168.150.157/elections-2018/hindi/telangana/pre_result_json_by_district/'.$dist);
			exec('curl http://192.168.150.157/elections-2018/hindi/telangana/pre_all_result_json_by_district/'.$dist);
		}
	}
	...
	function const_json()
	{
		...
		foreach($const as $row)
		{
			...
			echo $const.'<br>';
			exec('curl http://192.168.150.157/elections-2018/hindi/telangana/pre_result_json_by_const/'.$const);
		}
	}
