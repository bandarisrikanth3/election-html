...
<?php $_GLOBALS['graph_distname'] = $graph_distname; ?>
  ...
  <div class="col-md-12 col-sm-12 col-xs-12 ">
    <legend>निर्वाचन क्षेत्र का विवरण</legend>
     <?php echo str_ireplace('div','p',$district->hindidescription);?>
      <br/>
  </div>
  ...
  <div class="col-md-12 col-sm-12 col-xs-12 margin-top10">
      ...
      ?>
          ...
          <div class="table-responsive well">
            <table class="table table-bordered">
                <tr>
                  <th>जिले:</th>
                  <td><?php echo $district->hindiname;?></td>
                </tr>
                <tr>
                  <th> राज्य:</th>
   ...
   <!-- Previous Election Details -->
    <div class="col-md-6 col-sm-12 col-xs-12  ">
      <legend>पिछले चुनाव : वोट प्रतिशत</legend>
      <div class="col-md-12 col-sm-12 col-xs-12 well ">
 ...
 <!-- Previous Constituency Results -->
    <?php 
          ...
          {
    ?>
            <legend>पिछले चुनाव: निर्वाचन क्षेत्र में कौन है</legend>
            <div class="col-md-12 col-sm-12 col-xs-12  margin " >
              
              <?php 
                  foreach($seats_data as $row) 
                  {
                    if(!empty($row['tel_constname']))
                    {
              ?>
