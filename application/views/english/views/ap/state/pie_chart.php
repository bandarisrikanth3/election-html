...
<script type="text/javascript">
  ...
  function drawChart() {
     ...
     report = $.ajax({
       // url: url_pie,
        url: "<?php  echo '/elections-2018/Jsons/telangana/vote_share_state.json'?>",
        dataType: "json",
        async: false
        }).responseText;
   //alert(report);
