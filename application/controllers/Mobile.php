...
class Mobile extends CI_Controller {
	...
	function state($state)
	{
		...
		$this->load->view('common/mob_header');
		...
		$this->load->view('common/mob_footer');	
	}
...
*/
	...
	function state_json()
	{
			...
			exec('curl http://192.168.150.157/election_beta/telangana/pre_result_json_by_state/telangana');
			exec('curl http://192.168.150.157/election_beta/telangana/vote_share_json_state/telangana');
	...
	function district_json()
	{
		...
		foreach($district as $row)
		{
			...
			echo $dist.'<br>';
			exec('curl http://192.168.150.157/election_beta/telangana/pre_result_json_by_district/'.$dist);
			exec('curl http://192.168.150.157/election_beta/telangana/pre_all_result_json_by_district/'.$dist);
		}
	}
	...
	function const_json()
	{
		...
		foreach($const as $row)
		{
			...
			echo $const.'<br>';
			exec('curl http://192.168.150.157/election_beta/telangana/pre_result_json_by_const/'.$const);
		}
	}
