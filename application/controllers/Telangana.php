...
class Telangana extends CI_Controller {
	...
	function state($state)
	{
		...
		$this->load->view('english/views/ts/state/stateview',$data);
	...
	function district($district='')
	{
		...
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
			//print_r($data);
			$this->load->view('common/header',$data);
			$this->load->view('english/views/ts/district/all',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
		...
		$data['candidate_details_district'] = $this->Englishm->get_candidates_by_district($district);
			...
			$this->load->view('english/views/ts/district/districtview',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
	}
	...
	function constituency($const='')
	{
		...
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
			//print_r($data);
			$this->load->view('common/header',$data);
			$this->load->view('english/views/ts/constituency/all',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
		else
		...
		$data['candidate_details_const'] = $this->Englishm->get_candidates_by_const($const);
			...
			$this->load->view('english/views/ts/constituency/constview',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
	}
	...
	function party($party_state='')
	{
		...
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
			...
			$this->load->view('english/views/ts/party/all',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
		else
		{
			...
			$this->load->view('common/header');
			$this->load->view('english/views/ts/party/partyview',$data);
			$this->load->view('common/sidebar');	
			$this->load->view('common/footer');	
		}
	}
...
/*
	function candidate($candidate_state ='')
	{
		...
		$this->load->view('common/header');
		$this->load->view('english/views/ts/candidate/candidateview',$data);
		$this->load->view('common/sidebar');	
		$this->load->view('common/footer');	
	}
...
*/
	...
	function schedule()
	{
		...
		$this->load->view('common/header');
		$this->load->view('english/views/ts/election_schedule',$data);
		$this->load->view('common/sidebar');	
		$this->load->view('common/footer');	
	}
	...
	function campaign()
	{
		...
		$this->load->view('common/header');
		$this->load->view('english/views/ts/campaignview',$data);
		$this->load->view('common/sidebar');	
		$this->load->view('common/footer');	
	}
	...
	function notification()
	{
		...
		$this->load->view('common/header');
		$this->load->view('english/views/ts/notifications',$data);
		$this->load->view('common/sidebar');	
		$this->load->view('common/footer');	
	}
	...
	{
		$data['general_observers'] = $this->Englishm->get_general_observers();
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
		//print_r($data['campaigners_details'] );
	...
	{
		$data['police_observers'] = $this->Englishm->get_police_observers();
		$data['candidate_details_side'] = $this->Englishm->get_all_candidate_details();
		//print_r($data['campaigners_details'] );
 ...
 // ============================  Graph Json ============================================ //
	...
	function pre_result_json_by_state($state){
		...
		fclose($fp);
		echo $json;
		//$this->load->view('english/views/ts/state_chart');
	}
